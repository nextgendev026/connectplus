export interface RadioStation {
  ...
  icon: string;
  tagline: string;
  /** Real station logo when a stable, hotlink-friendly URL is available. */
  logoUrl?: string;
  programming: string[];
  favorite: boolean;
  verified: boolean;
...
// /api/radio/status resolves. `logoUrl` is optional: when unset the UI renders
// a branded station tile (gradient + call letters + frequency) instead.
export const STATIONS: RadioStation[] = [
  ...
  },
  {
    ...
    color: "#f43f5e",
    icon: "K",
    tagline: "Kampala's… Kenya's non-stop urban music",
  ...
  },
  {
    ...
    programming: ["Kenyan Hits", "Afro Pop Mix"],
    favorite: false,
    verified: true,
  },
  {
    ...
    programming: ["Wildlife Stories", "Safari Mix"],
    favorite: false,
    verified: true,
  },
