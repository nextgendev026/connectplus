...
const REGIONAL_STATIONS: RadioStation[] = [
  /* ============================== KENYA ============================== */
  {
    ...
    // image/x-icon.
    logoUrl: "/radio-logos/capital-fm.jpg",
   ...
   * can be verified: `npm run radio:check` is what says so. */
  {
    ...
    color: "#f59e0b",
    icon: "47",
    logoUrl: "/radio-logos/radio-47.png",
  ...
  },
  {
    ...
    color: "#eab308",
    icon: "M",
    logoUrl: "/radio-logos/milele-fm.png",
  ...
  },
  {
    ...
    color: "#14b8a6",
    icon: "RM",
    logoUrl: "/radio-logos/radio-maisha.png",
  ...
  },
  {
    ...
    color: "#16a34a",
    icon: "I",
    logoUrl: "/radio-logos/inooro-fm.png",
  ...
  },
  {
    ...
    color: "#ec4899",
    icon: "G",
    logoUrl: "/radio-logos/ghetto-radio.png",
  ...
  },
  {
    ...
    logoUrl: "/radio-logos/kameme-fm.png",
    tagline: "Kikuyu hits, news and talk",
   ...
   */
  {
    ...
    color: "#1d4ed8",
    icon: "RC",
    logoUrl: "/radio-logos/radio-citizen.png",
  ...
  },
  {
    ...
    color: "#0f766e",
    icon: "RJ",
    logoUrl: "/radio-logos/radio-jambo.webp",
  ...
  },
  {
    ...
    color: "#8b5cf6",
    icon: "NU",
    logoUrl: "/radio-logos/nrg-uganda.png",
  ...
  },
  {
    ...
    color: "#eab308",
    icon: "NR",
    logoUrl: "/radio-logos/next-radio.png",
  ...
  },
  {
    ...
    color: "#f97316",
    icon: "S",
    logoUrl: "/radio-logos/sanyu-fm.png",
  ...
  },
  {
    ...
    color: "#84cc16",
    icon: "CR",
    logoUrl: "/radio-logos/crown-fm.png",
  ...
  },
  {
    ...
    color: "#8b5cf6",
    icon: "CF",
    logoUrl: "/radio-logos/clouds-fm.png",
  ...
  /* ============================== RWANDA ============================== */
  {
    ...
    color: "#2563eb",
    icon: "RR",
    logoUrl: "/radio-logos/radio-rwanda.png",
  ...
  /* ============================== NIGERIA ============================== */
  {
    ...
    color: "#f59e0b",
    icon: "BF",
    logoUrl: "/radio-logos/beat-fm.png",
  ...
  },
  {
    ...
    color: "#06b6d4",
    icon: "CF",
    logoUrl: "/radio-logos/cool-fm.png",
  ...
  },
  {
    ...
    color: "#16a34a",
    icon: "W",
    logoUrl: "/radio-logos/wazobia-fm.jpg",
   ...
   * refuses unsigned requests (403), so there is no verifiable replacement. */
  {
    ...
    color: "#7c3aed",
    icon: "JF",
    logoUrl: "/radio-logos/jacaranda-fm.png",
  ...
  /* ============================ INTERNATIONAL =========================== */
  {
    ...
    color: "#991b1b",
    icon: "BBC",
    logoUrl: "/radio-logos/bbc-world.png",
   ...
   * card above already carries. One service, one card. */
  {
    ...
    color: "#06b6d4",
    icon: "NTV",
    logoUrl: "/radio-logos/kbc-english.png",
